/**
 * Migration: Add `year` field to DepartmentRequirement
 *
 * 1. Backfill existing documents with year: 2025
 * 2. Drop old unique index { college, departmentName }
 * 3. Create new unique index { college, departmentName, year }
 *
 * Idempotent: safe to run multiple times.
 *
 * Usage: npx tsx scripts/migrate-department-requirement-year.ts
 */
...
const COLLECTION_NAME = 'departmentrequirements';
const OLD_INDEX_NAME = 'college_1_departmentName_1';
const NEW_INDEX_SPEC = { college: 1, departmentName: 1, year: 1 } as const;
const NEW_INDEX_NAME = 'college_1_departmentName_1_year_1';
